...
/* profile.html.twig */
class __TwigTemplate_1f2d521293201ffa4f8d5b71ff559e5ddd1339119f585a7c790812fec23e887b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\tThis is the profile page of ";
        ...
        echo ") who has ";
        echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 7, $this->source); })()), "friends", [], "any", false, false, false, 7)), "html", null, true);
        echo " friends.
\t</div>
...
\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 12, $this->source); })()), "friends", [], "any", false, false, false, 12));
        foreach ($context['_seq'] as $context["_key"] => $context["friend"]) {
            // line 13
            echo "\t\t\t\t<li>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["friend"], "name", [], "any", false, false, false, 13), "html", null, true);
            echo "</li>
\t\t\t";
        }
...
";
    ...
    {
        return array (  116 => 15,  107 => 13,  103 => 12,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Profile | Friendface{% endblock %}

{% block body %}
\t<div class=\"row\">
\tThis is the profile page of {{ user.username }} ({{ user.email }}) who has {{ user.friends|length }} friends.
\t</div>
...
\t\t</ul>
\t</div>
{% endblock %}", "profile.html.twig", "/Users/trystan/Documents/Open Window/Symfony/friendface/templates/profile.html.twig");
    }
}
