...
/* register.html.twig */
class __TwigTemplate_7fc92472f04c1cb9b39b7799eeb496609ca0636a4b01f02c8497b528e93c4ab0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block title %}Register | Friendface{% endblock %}

{% block body %}
\t{{ form_start(form, {'attr': {'novalidate': 'novalidate'}}) }}
\t{{ form_widget(form) }}
\t{{ form_end(form) }}
{% endblock %}", "register.html.twig", "/Users/trystan/Documents/Open Window/Symfony/friendface/templates/register.html.twig");
    }
}
